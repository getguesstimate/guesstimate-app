...
export const extractInputs = n => ({...n, inputs: _utils.getSubMatches(n.expression, ID_REGEX, 1)})
...
export const withRelatives = nodes => n => ({...n, children: getChildren(n, nodes), parents: getParents(n, nodes)})
