...
export function organizationUsers(organizationId, users, memberships) {
  let filteredMemberships = organizationMemberships(
    organizationId,
    memberships
  );
