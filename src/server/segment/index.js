import {API_KEY, PURCHASE_ACTION} from './constants.js'
...
export function trackPurchaseFailure(planType) {
  window.analytics.track(PURCHASE_FAILURE_ACTION, {plan: planType})
}
