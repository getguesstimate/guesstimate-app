...
const SpaceListItem: React.FC<any> = ({
  space,
  showUser,
  isOwnedByMe,
  showScreenshot,
...
class SpaceListItemComponent extends Component<any> {
  render() {
...
export default connect(_.partialRight(_.pick, ["spaces", "me"]))(
  connect(denormalizedSpaceSelector)(SpaceListItemComponent)
);
