...
export const TutorialMetricPage = () => (
  <TutorialPage header='Metrics'>
    ...
    <table className='semantic ui table'>
      ...
      <tbody>
        <tr>
          <td><span className='exampleFunction'>100</span></td>
          <td>
            This value is exactly 100.
          </td>
        </tr>
        <tr>
          <td><span className='exampleFunction'>300 to 700</span></td>
          <td>
            This value is estimated to be between 300 and 700.
          </td>
        </tr>
      </tbody>
    </table>
...
export const TutorialMetricActionsPage = () => (
  <TutorialPage header='Metric Actions'>
    ...
    <table className='semantic ui table'>
      <tbody>
        <tr>
          <td><span className='rowLabel'>Move</span></td>
          <td>
            Click the metric center and drag it to another cell.
          </td>
        </tr>
        <tr>
          <td><span className='rowLabel'>Delete</span></td>
          <td>
            Press <strong>delete</strong> or <strong>backspace</strong>, or click
            the <strong>trash</strong> icon in the toolbar.
          </td>
        </tr>
        <tr>
          <td><span className='rowLabel'>Cut, Copy & Paste</span></td>
          <td>
            Press <strong>ctrl-x</strong>, <strong>ctrl-c</strong>, and <strong>ctrl-v</strong>.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <TutorialPage header='Functions'>
    ...
    <table className='semantic ui table'>
      ...
      <tbody>
        <tr>
          <td>
            <span className='exampleFunction'>= <span className='exampleInput'>FA</span> * 300</span>
          </td>
          <td><span className='exampleInput'>FA</span> times 300.</td>
        </tr>
        <tr>
          <td>
            <span className='exampleFunction'>= <span className='exampleInput'>FA</span> > 5 ? 100 : 0</span>
          </td>
          <td>If <span className='exampleInput'>FA</span> is greater than 5, 100.  If it is less, 0.</td>
        </tr>
      </tbody>
    </table>
  </TutorialPage>
