...
const SpaceHeader = ({couldBePrivate, space, isLoggedIn, onSave, onCopy, onDestroy, onPublicSelect, onPrivateSelect, onSaveName}) => {
      ...
      <div className='header-actions'>
        ...
        {space.editableByMe &&
          <PrivacyToggle
            ...
            position='right'
            isPrivateSelectionInvalid={!couldBePrivate}
