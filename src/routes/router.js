...
import {CalculatorShow} from 'gComponents/calculators/show'
import {NewCalculator} from 'gComponents/calculators/new'
...
export default Router.extend({
  ...
  routes: {
    ...
    'models/:id/calculators/new': 'newCalculator',
  ...
  newCalculator(id) { this.render(<NewCalculator space_id={parseInt(id)}/>, {showFooter: false, backgroundColor: 'GREY'}) },
})
