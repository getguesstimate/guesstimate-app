...
import {CalculatorNew} from 'gComponents/calculators/new/CalculatorNew'
...
export default Router.extend({
  ...
  calculatorNew(id) { this.render(<CalculatorNew space_id={parseInt(id)}/>, {showFooter: false, backgroundColor: 'GREY'}) },
})
