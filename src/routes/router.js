...
export default Router.extend({
  ...
  routes: {
    ...
    "organizations/:id(/:tab)": "organizationShow",
  ...
  spaceIndex() {
    this.render(<SpaceIndex />, { backgroundColor: "GREY" });
  },
  home() {
    this.render(<Home />, { isFluid: true, simpleHeader: true });
  },
  spaceNew() {
  ...
  spaceShowEmbed(id) {
    this.render(<SpaceShow spaceId={id} embed={true} />, {
      isFluid: true,
      showFooter: false,
      embed: true,
      fullHeight: true,
  ...
  scratchpad() {
    this.render(<SpaceShow spaceId={5170} />, {
      isFluid: true,
      showFooter: false,
    });
  },
  ...
  styleGuideSettings() {
    this.render(<SettingsStyleGuide />, { isFluid: true, showFooter: false });
  },
  styleGuideFirstSubscription() {
    this.render(<FirstSubscriptionStyleGuide />);
  },
  styleGuidePricing() {
    this.render(<PlansStyleGuide />);
  },
  styleGuideNewOrganization() {
    this.render(<OrganizationNewStyleGuide />);
  },
  maintenance() {
  ...
  authRedirect() {
    this.render(<AuthRedirect location={window.location} />);
  },
  subscribe(id) {
    this.render(<FirstSubscriptionPage planName={id} />);
  },
  userShow(id) {
    this.render(<UserShow userId={id} />, { backgroundColor: "GREY" });
  },
  organizationShow(id, tab = null) {
    this.render(<OrganizationShow organizationId={id} key={id} tab={tab} />, {
      backgroundColor: "GREY",
    });
  },
  organizationsNew() {
    this.render(<CreateOrganizationPageContainer />, {
      backgroundColor: "GREY",
    });
  },
  pricing() {
    this.render(<PlanIndex />, { backgroundColor: "GREY" });
  },
  calculatorExpandedShow(id) {
    this.render(
      <CalculatorExpandedShow calculatorId={parseInt(id)} key={parseInt(id)} />,
      { showFooter: false, backgroundColor: "GREY" }
    );
  },
});
