import {newFlowState, actions, states, subStage} from './state_machine.js'
...
describe('FirstSubscriptionStateMachine', () => {
  ...
  describe('#subStage', () => {
    ...
    it(`in form success state`, () => {
      let newStage = _.clone(defaultStage)
      newStage.flowStage = 'FORM'
      newStage.iframe.request = { waiting: false, error: null, status: 'SUCCESS' }
    ...
    it(`in synchronization start state`, () => {
      ...
      newStage.synchronization.request = {waiting: true, error: null, status: 'START' }
    ...
    it(`in synchronization success state`, () => {
      let newStage = _.clone(defaultStage)
      newStage.flowStage = 'SYNCHRONIZATION'
      newStage.synchronization.request = {waiting: true, error: null, status: 'SUCCESS' }
